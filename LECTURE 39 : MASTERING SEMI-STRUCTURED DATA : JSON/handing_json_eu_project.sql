...
CREATE TABLE IF NOT EXISTS IOT_DB.IOT_SCHEMA.LOAD_IOTV2_EUEXPERIENCE00320055 
(
...
SELECT  data:startMCUtemperature::VARCHAR as START_MCU_TEMPERATURE,
data:endMCUtemperature::VARCHAR as END_MCU_TEMPERATURE,
...
SQL NULL: SQL NULL means the same thing for semi-structured data types as it means for structured data types:
